...
function preload_assets() {
  for (var i in flavors) {
    flavor_assets[flavors[i]] = {
      arrowsm:  preload_image('assets/flavors/' + flavors[i] + '/arrowsm.png'),
      arrowbig: preload_image('assets/flavors/' + flavors[i] + '/arrowbig.png'),
      dialog:   preload_image('assets/flavors/' + flavors[i] + '/dialog.png'),
    };

    flavor_assets[flavors[i]].glyphs = (flavors[i] == 'plain') ? preload_image('assets/textplain.png') : preload_image('assets/textflavored.png');
  }
}
